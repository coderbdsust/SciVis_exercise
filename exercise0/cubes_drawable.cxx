...
public:
	...
	cubes_drawable()
		...
		bgcolor(fb_bgcolor_r, fb_bgcolor_g, fb_bgcolor_b), draw_backside(false), draw_quad(false)
	{}
	...
	bool self_reflect(cgv::reflect::reflection_handler& rh)
	{
		...
		return
			...
			rh.reflect_member("draw_quad", draw_quad);
	}
	...
	bool init(cgv::render::context& ctx)
	{
		...
		cubes_fractal.use_vertex_array(&vertex_array, sizeof(vertex_array), 0);
	...
	void draw(cgv::render::context& ctx)
	{
		...
		cubes_fractal.draw_recursive(ctx, cube_color, 7, 0);
